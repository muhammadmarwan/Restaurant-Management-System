...
<section class="content">
    <div class="card-header">
        <h3 class="card-title"><b>Salary <small>  Setup</small></b></h3>
    </div>
    <div class="card-body">
    <div class="row">
          ...
          <div class="col-lg-2 col-6">
            ...
            @endif
              <div class="inner">
                <h4>Salary Receivable</h4>
              </div>
              <div class="icon">
              <i class="fas fa-credit-card"></i>
              </div>
              <a href="#" id="setup" data-toggle="modal" data-target="#exampleModal2" data-id="2"
              class="small-box-footer passingID">
              @if($count2!=null)
                <b>Selected</b>
              @else
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="{{ Route('storeSalarySetup') }}">
      @csrf
